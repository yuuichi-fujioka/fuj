// @apiVersion 0.1
// @name work.fujioka.pkg.s3backup
// @description backup pvc to s3 or s3 compatible object storage
// @shortDescription backup job
...
// @optionalParam endpoint string null endpoint url. if this is null, this job backup pvc to s3
